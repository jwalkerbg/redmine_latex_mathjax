...
Redmine::Plugin.register :redmine_latex_mathjax do
  ...
  settings :default => {
    'latex_mathjax_url' => Redmine::VERSION::MAJOR >= 6 ?
      '/assets/plugin_assets/redmine_latex_mathjax/mathjax/es5/tex-chtml.js' :
      '/plugin_assets/redmine_latex_mathjax/mathjax/es5/tex-chtml.js',
